(() => {
  {
    (() => {
      ...
      function SlideFrame({ variant = "page", pad = true, footer = true, slideNo, children, style = {} }) {
        const bg = variant === "ink" ? COLORS.ink : variant === "paper" ? COLORS.paper : variant === "bleed" ? COLORS.cream : COLORS.cream;
        ...
        return /* @__PURE__ */ React.createElement(
          ...
          footer && /* @__PURE__ */ React.createElement(SlideFooter, { variant, slideNo })
        );
      }
      function SlideFooter({ variant, courseLabel, deckLabel }) {
        ...
        return /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement("span", null, courseLabel || meta.courseLabel || "HTCS"),
          /* @__PURE__ */ React.createElement("span", null, deckLabel || meta.deckTitle || meta.deckLabel || "")
        );
      }
      ...
      function Rule({ color, style = {} }) {
        return /* @__PURE__ */ React.createElement("div", { style: { height: 1, background: color || COLORS.rule, width: "100%", ...style } });
      }
      ...
      function Bullet({ children }) {
        return /* @__PURE__ */ React.createElement("li", { style: { marginBottom: 14 } }, children);
      }
      function BulletList({ items, children, style = {}, gap = 14 }) {
        const renderedChildren = items ? items.map((item, index) => /* @__PURE__ */ React.createElement(Bullet, { key: index }, item)) : children;
        return /* @__PURE__ */ React.createElement(
          "ul",
          {
            style: {
      ...
      function ToggleButton({ active = false, tone = "ghost", children, ...props }) {
        return /* @__PURE__ */ React.createElement(DeckButton, { tone, active, ...props }, children);
      }
